...
<html lang="cn">
	<head>
		...
		<title>Scutonlinemall后台管理</title>

		<meta name="description" content="Scutonlinemall 微商城 微信商城" />
									...
									<div class="tab-pane active">
										<table cellpadding="2" cellspacing="2" width="100%">
											<tbody>
												...
												<tr>
													<td>微信原始账号:</td>
													<td><input type="text" class="input" name="ini_num"
														value="<?php echo ($config["ini_num"]); ?>" id="name"></td>
												</tr>
												<tr>
													<td>url:</td>
												...
												<tr>
													...
													<td><input disabled="disabled" type="text" class="input" name="partnerid"
																id="url_input" value="<?php echo ($config["partnerid"]); ?>" autocomplete="off">
													</td>
												</tr>
												<tr>
													<td>partnerkey:</td>

													<td><input disabled="disabled" type="text" class="input" name="partnerkey"
																id="url_input" value="<?php echo ($config["partnerkey"]); ?>" autocomplete="off">
													</td>
												</tr>
												<tr>
													<td>paysignkey:</td>

													<td><input disabled="disabled" type="text" class="input" name="paysignkey"
																id="url_input" value="<?php echo ($config["paysignkey"]); ?>" autocomplete="off">
													</td>
												</tr>
											</tbody>
										</table>
									...
									<table id="sample-table-1"
										...
										<tbody>
											<?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
												...
												<th width="100"><?php echo ($menu["menu_id"]); ?></th>
												<th><?php echo ($menu["menu_name"]); ?></th>
												<th width="80"><?php echo ($menu["menu_type"]); ?></th>
												<th width="200"><?php echo ($menu["view_url"]); ?></th>
												<th><?php echo ($menu["event_key"]); ?></th>
												<td><a
													href="javascript:void(0);" onclick="reWxmenu(this)"
													class="btn btn-white btn-sm">修改</a><a
													class="J_ajax_del btn btn-white btn-sm"
													href="<?php echo U('Admin/Weixin/delmenu',array('id'=>$menu['menu_id']));?>">删除</a></td>
